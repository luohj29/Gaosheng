---
title: "GT3: Silla de oficina ergonómica con inclinación y bloqueo 2D en reposabrazos"
description: "La serie GT3 es la colección creada por el equipo de I+D de Nuogo en colaboración con el equipo de diseño japonés TOYO TAPER, siendo una extensión y complemento de las sillas de oficina GT1 y GT2. La GT3A continúa utilizando el mismo mecanismo de inclinación por peso propio que la GT2A, que se basa en el peso del usuario cuando la gravedad del cuerpo se inclina hacia atrás, para ofrecer el soporte más cómodo. Esta nueva colección resulta refrescante con su carcasa de plástico y respaldo perforado. La silla puede orientarse más fácilmente a una gama más amplia de países y regiones. Ofrece una alta relación costo-efectividad, con un diseño simple, moderno y elegante."
images:
...
Característica: GT3A - Mecanismo de Inclinación por Peso Propio
Aplicación: Entorno de oficina, sala de recepción de hotel, habitación de huéspedes, espacio educativo escolar.
...
- Moldeado integrado.
- Un respaldo flexible, suave y transpirable.
- Soporte mecánico de dos puntos.

### Punto A
Los radianes verticales proporcionan soporte al respaldo.
### Punto B
...
## Especificaciones:
1. CERTIFICADO BIFMA:
2. Respaldo: Material PP de buena calidad con tubo metálico Φ25mm*T1.5mm. Se puede añadir cojín para el respaldo. La tecnología de respaldo sin tornillos es patentada.
3. Cojín del asiento: Espuma moldeada de densidad 55 con contrachapado de 12mm cubierto por tela tapizada.
4. Reposabrazos: Reposabrazos con almohadilla de PP, altura ajustable, se puede quitar.
5. Mecanismo: Sistema de mecanismo de peso propio con elevación y posición de bloqueo, ofreciendo mayor comodidad para la espalda del usuario, inclinación (rango de 90-108 grados).
6. Elevador de gas: Elevador de gas Withus 100-40#. Su vida útil es de 120.000 ciclos de subida y bajada.
7. Base: Base de nailon R310mm que pasa la certificación BIFMA. Puede soportar una presión de 1136 kg.
...
3. Reposabrazos 2D ajustables en altura.
...
3. Se puede añadir cojín para el respaldo según necesidad.
...
2. Reposabrazos 2D ajustables en altura.
3. Se puede añadir cojín para el respaldo según necesidad.
4. Base de tubo redondo de gran diámetro 25mm*espesor 2mm.
5. Para uso en salas de reuniones, áreas de recepción. -->