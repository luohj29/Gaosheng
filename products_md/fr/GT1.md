---
title: "GT1 : Fauteuil de bureau ergonomique haut dossier design original"
description: "Le fauteuil haut dossier GT est un modèle de qualité supérieure conçu en collaboration par Gao Sheng et TOYO Taper. Il est non seulement agréable à l'œil, mais aussi confortable à l'assise. Son dossier incurvé vous offre une sensation de confort optimal."
images:
...
## Spécifications :
+   CERTIFICATION BIFMA :
+   1, Dossier : Structure principale en PP de qualité avec filet et appui-tête réglable (cadre PP disponible en noir ou blanc) ;
+   2, Porte-manteau : disponible ;
+   3, Coussin d'assise : Mousse injectée haute densité 55 recouverte de tissu, coulissante ;
+   4, Support lombaire : hauteur réglable ;
+   5, Accoudoirs : Coussin en PU de qualité et réglable ;
+   6, Mécanisme : Mécanisme multifonction, montée/descente, inclinaison et verrouillage ;
+   7, Base : Base en aluminium poli, charge max 1000kg, conforme BIFMA ;
...
-Les leviers, facilement accessibles à la main, vous permettent de faire coulisser facilement l'assise vers l'avant et l'arrière.

DGT intègre des caractéristiques Classiques et Élégantes, exprimant pleinement la prospérité, la Perfection et la Sagesse. Excellent dans chaque détail.

Le filet utilisé dans la Nouvelle Série est respirant et léger. Grâce à sa propriété de tension, il offre plus de confort et soulage le stress simultanément.

Les nouvelles collections de fauteuils de bureau Gaosheng intègrent un système synchronisé où le dossier et l'assise bougent ensemble avec l'utilisateur pour fournir un soutien continu et persistant. Le dossier enveloppe l'utilisateur quelle que soit sa posture ou l'appareil utilisé.

-Vous pouvez utiliser le bouton de réglage de tension situé sous l'assise, facilement accessible, pour ajuster finement la tension d'inclinaison selon vos préférences.
Appui-tête
Coque extérieure blanche ou noire en polypropylène moulé (100% recyclable).

Surface en Tissu/Cuir
Rembourrage sur mousse de polyuréthane (recyclable en sous-couche de moquette, ouate, etc.)
Surface en Filet
76% élastomère / 24% polyester, filet haute résistance.

Assise : Réglable en hauteur et coulissante
Coque extérieure blanche ou noire en polypropylène injecté-moulé (100% recyclable)

Base : Base cinq branches en alliage d'aluminium moulé sous pression (100% recyclable) avec finition chromée ou polie. Roulettes doubles de 60mm en polyamide (nylon) moulé.
réglage préféré.

Dossier : Réglable en hauteur et hauteur lombaire.
Coque extérieure, bouton lombaire et capuchons en polypropylène (100% recyclable). Cadre du dossier en polypropylène renforcé de fibres blanc (100% recyclable).

Accoudoirs : Réglables en hauteur et angle de pivotement.
Coussin d'accoudoir en mousse PU intégrale de couleur noire standard, moulé sur une coque en PP.
