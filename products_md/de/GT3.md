---
title: "GT3: Ergonomische 2D-Armlehnen-Neigungs- und Verstellfunktion Bürodrehstuhl"
description: "Die GT3-Serie ist eine Kollektion, die vom Nuogo-Forschungsteam in Zusammenarbeit mit dem japanischen Designteam TOYO TAPER entwickelt wurde und eine Erweiterung und Ergänzung der Bürostühle GT1 und GT2 darstellt. Die GT3A verwendet weiterhin den gleichen Selbstgewichts-Neigungsmechanismus wie die GT2A, der basierend auf dem Gewicht des Nutzers bei Rückwärtsbewegung des Oberkörpers den komfortabelsten Support bietet. Die neue Kollektion besticht durch ihr Kunststoffgehäuse und die perforierte Rückenlehne. Der Stuhl kann leichter auf eine breitere Palette von Ländern und Regionen ausgerichtet werden. Mit hohem Preis-Leistungs-Verhältnis, einfachem Design und Eleganz."
images:
...
Merkmal: GT3A-Selbstgewichts-Neigungsmechanismus
Anwendung: Büroumgebung, Hotel-Empfangsbereich, Gästezimmer, Bildungsräume.
...
- Integriert geformt.
- Eine flexible, glatte, atmungsaktive Rückenlehne.
- Zwei-Punkt-Mechanik-Unterstützung.

### Punkt A
Vertikale Radien bieten Rückenlehnen-Unterstützung.
### Punkt B
...
## Spezifikationen:
1. BIFMA-Zertifikat bestanden:
2. Rückenlehne: hochwertiges PP-Material mit Metallrohr Φ25mm*T1,5mm. Rückenlehnenkissen kann hinzugefügt werden. Die schraubenlose Rückenlehne ist eine patentierte Technologie.
3. Sitzkissen: 55-Dichte-Schaumstoff mit 12 mm Sperrholz, bezogen mit Polsterstoff.
4. Armlehnen: Armlehnen mit PP-Polster, höhenverstellbar, abnehmbar.
5. Mechanismus: Selbstgewichts-Neigungsmechanismus mit Höhenverstellung und Verriegelungspositionen sowie mehr Komfort für den Rücken des Nutzers, Neigung (Bereich von 90-108 Grad).
6. Gasfeder: Withus-Gasfeder 100-40#. Ihre Lebensdauer beträgt 120.000 Auf- und Abbewegungen.
7. Basis: R310mm Nylonbasis mit BIFMA-Zertifikat. Hält einem Druck von 1136 kg stand.
...
Unser Unternehmen befindet sich im Xi'an Industriegebiet, Xiqiao Stadt, Nanhai Bezirk, Foshan Stadt, Guangdong Provinz, China. Willkommen! Das Unternehmen umfasst eine Fläche von 110.000 Quadratmetern und beschäftigt 600 Mitarbeiter. Die Fabrik hat die ISO9001:2000- und ISO14001:2004-Zertifizierung bestanden. Produkte werden in die USA, Japan, Großbritannien, Australien, Deutschland, Frankreich, Italien, die Niederlande, den Nahen Osten, Schweden, Dänemark, Kanada, den Nahen Osten und Südostasien und andere Länder und Regionen exportiert.
...
3. Höhenverstellbare 2D-Armlehnen.
...
3. Rückenlehnenkissen kann nach Bedarf hinzugefügt werden.
...
2. Höhenverstellbare 2D-Armlehnen.
3. Rückenlehnenkissen kann nach Bedarf hinzugefügt werden.
4. Basis mit großem Durchmesser (25 mm * Dicke 2 mm Rundrohr).
5. Geeignet für Besprechungsräume, Empfangsbereiche. -->