---
title: "GT3 : Fauteuil de bureau ergonomique avec inclinaison et blocage 2D des accoudoirs"
description: "La série GT3 est la collection créée par l'équipe R&D de Nuogo en coopération avec l'équipe de design japonaise TOYO TAPER. Elle constitue l'extension et le complément des fauteuils de bureau GT1 et GT2. Le GT3A continue d'utiliser le même mécanisme d'inclinaison par poids corporel que le GT2A, qui s'adapte au poids de l'utilisateur lorsque le dos se penche en arrière sous l'effet de la gravité, pour offrir le soutien le plus confortable. Cette nouvelle collection se distingue par son dossier en coque plastique perforé. Le fauteuil peut ainsi être plus facilement adapté à un plus large éventail de pays et de régions. Il allie un excellent rapport qualité-prix, une esthétique simple et élégante."
images:
...
Caractéristique : GT3A - Mécanisme d'inclinaison par poids corporel
Application : Environnement de bureau, salle de réception d'hôtel, chambre d'hôte, espace éducatif scolaire.
...
- Moulage intégré.
- Un dossier flexible, lisse et respirant.
- Soutien mécanique à deux points.

### Point A
Les radians verticaux assurent le soutien du dossier.
### Point B
...
## Spécifications :
1. CERTIFICAT BIFMA validé :
2. Dossier : Matériau PP de bonne qualité avec tube métallique Φ25mm*T1.5mm. Possibilité d'ajouter un coussin de dossier. L'absence de vis à l'arrière est une technologie brevetée.
3. Coussin de siège : Mousse moulée densité 55 avec contreplaqué de 12mm recouvert de tissu d'ameublement.
4. Accoudoirs : Accoudoirs avec coussin PP, réglables en hauteur, amovibles.
5. Mécanisme : Système de mécanisme à inclinaison par poids corporel avec réglage de la hauteur et position de verrouillage, offrant un grand confort pour le dos de l'utilisateur, inclinaison (de 90 à 108 degrés).
6. Colonne gaz : Colonne gaz Withus 100-40#. Sa durée de vie est de 120 000 cycles de montée/descente.
7. Base : Base nylon R310mm certifiée BIFMA. Peut supporter une pression de 1136 kg.
...
3. Accoudoirs 2D réglables en hauteur.
...
3. Possibilité d'ajouter un coussin de dossier selon vos besoins.
...
2. Accoudoirs 2D réglables en hauteur.
3. Possibilité d'ajouter un coussin de dossier selon vos besoins.
4. Base avec gros tube rond de 25mm de diamètre et 2mm d'épaisseur.
5. Utilisation pour salles de réunion, zones de réception. -->