---
title: "GT3：人間工学に基づいた2Dアームレストチルト＆ロック機能付きオフィスチェア・タスクチェア"
description: "GT3シリーズは、Nuogoの研究開発チームが日本のデザインチームTOYO TAPERと協力して生み出したコレクションであり、オフィスチェアGT1とGT2の拡張および補完となります。GT3Aは、GT2Aと同じ自重チルト機構を継続して採用しています。この機構は、ユーザーの体重に基づいて背中が後方に傾く際に、最も快適なサポートを提供します。プラスチックシェルと通気性のあるメッシュ背もたれを採用した新コレクションは、新鮮な印象を与えます。このチェアは、より広範な国や地域に向けて容易に展開できます。高コストパフォーマンス、シンプルでファッショナブル、そしてエレガントなデザインが特徴です。"
images:
...
## 仕様:
1. BIFMA認証取得済み:
2. 背もたれ: 高品質PP材質、メタルチューブ Φ25mm*T1.5mm。背もたれクッション追加可能。背面ネジなしは特許技術。
3. 座面クッション: 密度55の成形フォーム、12mm合板、ファブリックカバー。
4. アームレスト: PPパッド付きアームレスト、高さ調整可能、取り外し可能。
5. 機構: 昇降・位置固定機能付き自重チルト機構システム、ユーザーの背中に高い快適性を提供、チルト角度（90-108度）
6. ガスリフト: Withus製ガスリフト 100-40#。寿命は上下120,000回。
7. ベース: R310mmナイロンベース、BIFMA認証取得済み。1136kgの圧力に耐えます。
...
2. 上下調整可能な2Dアームレスト。
3. 必要に応じて背もたれクッションを追加可能。
4. 大口径25mm*厚さ2mm丸管ベース。
5. 会議室、受付エリアでの使用に適しています。 -->